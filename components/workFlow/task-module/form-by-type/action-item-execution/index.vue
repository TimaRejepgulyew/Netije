        ...
        >
            <DxGroupItem>
                ...
                >
                    <DxLabel
                        location="left"
                        :text="$t('task.fields.subjectTask')"
                    />
                    <DxRequiredRule
                        :message="$t('task.validation.subjectRequired')"
                    />
                </DxSimpleItem>
                <DxGroupItem :col-count="5">
                    <DxGroupItem :col-span="5" :col-count="2">
                        ...
                        >
                            <DxLabel
                                location="left"
                                :text="$t('task.fields.assignedBy')"
                            />
                            <DxRequiredRule
                                :message="
                                    $t('task.validation.assignedByRequired')
                                "
                            />
                        </DxSimpleItem>
                        ...
                        >
                            <DxLabel
                                location="left"
                                :text="$t('task.fields.supervisor')"
                            />
                            <DxRequiredRule
                                :message="
                                    $t('task.validation.supervisorRequired')
                                "
                            />
                        </DxSimpleItem>
                    </DxGroupItem>
                ...
                <DxGroupItem :col-count="2">
                    ...
                    >
                        <DxLabel
                            location="left"
                            :text="$t('task.fields.observers')"
                        />
                    </DxSimpleItem>
                </DxGroupItem>
                <DxGroupItem
                    :col-span="5"
                    :template="actionItemTypeComponent"
                />
            </DxGroupItem>
            <DxSimpleItem
                :col-span="5"
        ...
        isUnderControlOptions () {
            return {
                ...
                onValueChanged: e => {
                    ...
                    this.$store.commit(
                        `tasks/${this.taskId}/SET_SUPERVISOR`,
                        null
                    )
                }
            }
