...
import gearIcon from "~/static/icons/quide-page/gear.svg";
    ...
    const administration = [
        {
            ...
            items: [
                {
                    name: context.$t(
                        "companyStructure.imports.importCompanies"
                    ),
                    params: {
                        async onChange(context, file) {
                            return await context.$axios.post(
                                dataApi.import.companies,
                                file
                            );
                        }
                    },
                ...
                {
                    name: context.$t(
                        "companyStructure.imports.importEmployees"
                    ),
                    params: {
                        async onChange(context, file) {
                            return await context.$axios.post(
                                dataApi.import.employees,
                                file
                            );
                        }
                    },
            ...
            items: [
                {
                    ...
                    description: context.$t(
                        "administration.usersAndGroups.rolesDescr"
                    ),
                ...
                },
                {
                    ...
                    description: context.$t(
                        "administration.usersAndGroups.usersDescr"
                    ),
                    visible: false
                },
                {
                    ...
                    description: context.$t(
                        "administration.usersAndGroups.groupsDescr"
                    ),
                    visible: false
                },
                {
                    name: context.$t(
                        "administration.usersAndGroups.usersAccount"
                    ),
                    description: context.$t(
                ...
                {
                    name: context.$t(
                        "administration.usersAndGroups.activeUsers"
                    ),
                    description: context.$t(
                    ...
                    params: {
                        ...
                        async onChange(context, file) {
                            await context.$axios.post(
                                dataApi.docFlow.DocumentRegisterReport
                                    .UploadTemplate,
                                file
                            );
                        }
        ...
        {
            icon: gearIcon,
            title: context.$t("modulesConfig.title"),
            items: [
                {
                    name: context.$t("modulesConfig.link"),
                    description: context.$t("modulesConfig.description"),
                    path: pathGenerate("modules-config"),
                    visible: true
                }
            ]
        }
