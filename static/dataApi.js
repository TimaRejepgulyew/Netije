export default {
  UserPhotoHash:process.env.NODE_ENV ==="production" ? document.location.origin + "StaticFiles/Employees/Thumbnails/" : "http://192.168.4.159/StaticFiles/Employees/Thumbnails/",
