export default {
  ...
  headerDescription:
    "Bu modul kärhananyň resminamadolanşygyny sazlamak üçin niýetlenen",
  personalSetting: {
  ...
  documentSetting: {
    ...
    documentTemplate: "Resminamalaryň nusgasy",
    ...
    categoriesDescr:
      "Resminamalaryň görnüşiniň çäginde şertnamalaryň goşmaça klasifikasiýasy"
  },
  regSetting: {
    title: "Hasaba almak we belgilemek",
    registration: "Hasaba alyş žurnaly",
    registrationDescr:
      "Resminamalary belgilemek we hasaba almak üçin žurnallaryň sanawy",
    ...
    registrationSettingsDescr:
      "Resminamanyň maglumatlaryna görä bellige alyş kitapçasyny awtomatiki saýlaýyş kadalary",
  ...
  caseFileSetting: {
    ...
    caseFileDescr:
      "Iş bukjalaryna ulgamlaşdyrylan sanawy. Işlere bir meselä ýa-da bir iş çägine degişli resminamalar ýerleşdirilýär",
  ...
  associatedAppSetting: {
    ...
    fileTypeDescr:
      "Işläp geçiji goşundylaryň toparlary üçin niýetlenen faýllaryň görnüşleri",
    associatedApp: "Işläp geçiji goşundylar",
    associatedAppDescr:
      "Resminamalarda ulanyp boljak faýl giňeltmelerini kesgitleýän gollanma"
  },
  fields: {
