...
export default {
    ...
    translations: {
        fields: {
            ...
            maxLength:
                "Belgileriň aňryçäk uzynlygy görkezilenden köp bolmaly däldir",
            bankId: "Bank",
            ...
            generateDocumentName:
                "Resminamanyň adyny awtomatik görnüşde döretmeli",
    ...
    modulesConfig: {
        title: "Netije modullaryny sazlamak",
        description: "Islenýän Netije funksiýasyny düzmäge mümkinçilik berýär",
        link: "Sazlaň",

        config: {
            antivirus: "Antivirus",
            financialAndContractualDocs: "Maliýe we şertnama resminamalary",
            dynamicDocuments: "Dinamiki resminamalar",
            documentTemplates: "Resminama şablonlary",
            orgLimitation: "Guramaçylyk gurluşynyň çäklendirilmegi",
            filesEditing: "Word we Excel faýllaryny brauzerde redaktirlemek",
            internalExchange: "Resminamalaryň içerki alyş-çalşygy",
            externalExchange: "Elektron resminama alyş-çalşygy",
            chat: "Söhbet otagy"
        }
    }
};
