...
export default {
    ...
    validation: {
        ...
        valueMustNotContainsSpaces:
            "В значении не должны присутствовать пробелы"
    },
    DocumentQuery: {
    ...
    shared: {
        alert: {
            ...
            notHaveAccessRightToRead:
                "У вас не достаточно прав на данный обьект",
    ...
    modulesConfig: {
        title: "Настройка модулей Netije",
        description: "Позволит настроить нужный функционал Netije",
        link: "Настроить",

        config: {
            antivirus: "Антивирус",
            financialAndContractualDocs: "Финансовые и договорные документы",
            dynamicDocuments: "Динамические документы",
            documentTemplates: "Шаблоны документов",
            orgLimitation: "Ограничение орг структуры",
            filesEditing: "Редактирование файлов Word и Excel в браузере",
            internalExchange: "Внутренний обмен документов",
            externalExchange: "Электронный обмен документов",
            chat: "Чат"
        }
    }
};
