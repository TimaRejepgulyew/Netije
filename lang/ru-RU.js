export default {
  ...
  "translations": {
    ...
    "fields": {
      ...
      "addresseeIdRequired":"Выберите адрессата",
    ...
    "headers": {
      ...
      "addIncomLetter":"Добавить входящий документ",
      "addAddendum":"Добавить приложение к документу",
      "addMemo":"Добавить служебную записку",
      "addOrder":"Добавить приказ",
      "addOutgoingLetter":"Добавить исходящиий документ",
